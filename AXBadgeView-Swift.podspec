#
#  Be sure to run `pod spec lint AXBadgeView-Swift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "AXBadgeView-Swift is a tool to add badge view to your projects on ios platform using swift."
  ...
  s.source       = { :git => "https://github.com/devedbox/AXBadgeView-Swift.git", :tag => "0.0.1" }
  ...
  s.source_files  = "AXBadgeView-Swift/AXBadgeView/AXBadgeView.swift"
